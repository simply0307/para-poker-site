...
import { formatPotWithBb } from "@/modules/para-poker/lib/poker/potUnits";
import { displaySessionTableLabel, getSessionPublicCopy, readPublicCopySettings } from "@/modules/para-poker/lib/newsroom/publicCopySettings";
    ...
    <NewsroomShell eyebrow="Session Recap">
      ...
      <DataTableShell
        ...
        renderRow={(result, index) => {
          ...
          const playerHref = participant.slug || result.player_id ? `/para/poker/players/${encodeURIComponent(text(participant.slug || result.player_id))}` : "";
          return (
