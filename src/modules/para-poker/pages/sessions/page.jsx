import { CardGrid, LeagueHero, NewsroomShell, SessionCard, StatCard, StatStrip } from "@/modules/para-poker/components/newsroom/NewsroomShell";
      ...
      <CardGrid>
        {sessions.length ? sessions.map((session) => {
          ...
          return (
            <SessionCard
              key={session.id}
              href={`/para/poker/sessions/${encodeURIComponent(text(session.session_code || session.id))}`}
