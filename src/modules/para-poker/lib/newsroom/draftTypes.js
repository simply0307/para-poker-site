...
export const draftTypes = {
  [DRAFT_TYPE_KEYS.SESSION_RECAP]: {
    ...
    publicRoutePattern: "/para/poker/sessions/[sessionId]",
  ...
  [DRAFT_TYPE_KEYS.PLAYER_PROFILE]: {
    ...
    publicRoutePattern: "/para/poker/players/[playerId]",
  ...
  [DRAFT_TYPE_KEYS.PLAYER_SESSION_RECAP]: {
    ...
    publicRoutePattern: "/para/poker/players/[playerId] and /para/poker/sessions/[sessionId]",
    adminRoutePattern: "/admin/players/[playerId]",
  ...
  [DRAFT_TYPE_KEYS.STANDINGS_SUMMARY]: {
    ...
    publicRoutePattern: "/para/poker/standings",
  ...
  [DRAFT_TYPE_KEYS.MOMENT_BLURB]: {
    ...
    publicRoutePattern: "/para/poker/moments",
  ...
  [DRAFT_TYPE_KEYS.LEAGUE_ARTICLE]: {
    ...
    publicRoutePattern: "/para/poker/articles/[articleId]",
...
const DRAFT_PUBLISH_TARGETS = {
  [DRAFT_TYPE_KEYS.SESSION_RECAP]: { route: "/para/poker/sessions/[sessionId]", slot: "session_recap" },
  [DRAFT_TYPE_KEYS.PLAYER_PROFILE]: { route: "/para/poker/players/[playerId]", slot: "player_profile" },
  [DRAFT_TYPE_KEYS.PLAYER_SESSION_RECAP]: { route: "/para/poker/players/[playerId]", slot: "player_session_recap" },
  [DRAFT_TYPE_KEYS.STANDINGS_SUMMARY]: { route: "/para/poker/standings", slot: "standings_summary" },
  [DRAFT_TYPE_KEYS.MOMENT_BLURB]: { route: "/para/poker/moments", slot: "moment_blurb" },
  [DRAFT_TYPE_KEYS.LEAGUE_ARTICLE]: { route: "/para/poker/articles/[articleId]", slot: "article" },
