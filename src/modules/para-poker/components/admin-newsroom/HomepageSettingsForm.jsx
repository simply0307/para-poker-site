...
import { DEFAULT_HOME_SETTINGS, HOMEPAGE_MODULE_DEFINITIONS } from "@/modules/para-poker/lib/newsroom/homepageSettingsConstants";
    ...
    <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_360px]">
      <section className="rounded-lg border border-zinc-300 bg-white p-5 shadow-sm">
        <div className="flex flex-wrap items-end justify-between gap-3 border-b border-zinc-200 pb-4">
          ...
          <div className="flex flex-wrap gap-2">
            <Link href="/para/poker" className="rounded-sm border border-zinc-300 px-3 py-2 text-xs font-black uppercase tracking-[0.12em] text-zinc-700 hover:border-zinc-900">
              View homepage
            </Link>
            <button
              type="button"
      ...
      <aside className="space-y-4">
        <section className="rounded-lg border border-zinc-300 bg-white p-5 shadow-sm">
          ...
          <Link href="/para/poker" className="mt-4 inline-flex rounded-sm bg-zinc-950 px-3 py-2 text-xs font-black uppercase tracking-[0.12em] text-white hover:bg-zinc-800">
            View homepage
          </Link>
        </section>
