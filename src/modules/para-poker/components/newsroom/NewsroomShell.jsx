...
import { PublicNav } from "@/modules/para-poker/components/newsroom/PublicNav";
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[#05080b] text-stone-100">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 py-5 md:px-8">
        <nav aria-label="Para Poker League" className="flex flex-wrap items-center justify-between gap-3 rounded-md border border-[#d8c087]/25 bg-[#061019]/88 px-3 py-2.5 shadow-2xl shadow-black/45 backdrop-blur sm:flex-nowrap md:px-4 md:py-3">
          <Link href="/para/poker" className="flex min-w-0 shrink-0 items-center gap-2.5 tracking-wide text-white md:gap-4">
